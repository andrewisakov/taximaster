...
class OktellOrderNoCars(OktellSoundMixin, BaseEvent):
...
class OktellOrderAccepted(OktellSoundMixin, BaseEvent):
...
class OktellOrderCrewAtPlace(OktellSoundMixin, BaseEvent):
...
class OktellOrderClientGone(OktellSoundMixin, BaseEvent):
